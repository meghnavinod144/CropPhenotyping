...
This project focuses on **crop phenotyping and health analysis** using
machine learning concepts.\
It provides a web-based interface where users can explore crop growth
parameters and disease-related insights.
...
-   `home.html` -- Dashboard\
-   `growth.html` -- Growth analysis\
-   `disease.html` -- Disease information\
-   `upload.html` -- Data input\
-   `css/` -- Styling\
-   `js/` -- Scripts
...
agriculture**, focusing on building a foundation for intelligent crop
monitoring systems using machine learning.
